...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "latticegames@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "latticegames API";

        private String description = "latticegames API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "latticegames";
